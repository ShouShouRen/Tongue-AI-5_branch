# dataset.py — (kept your logic; added stronger but structure-safe augments)
import os
import pandas as pd
...
# ... keep your rotate_upright(...) here unchanged ...
# (Paste your original rotate_upright implementation)
